            ...
            <div className="sticky top-0 z-20 hidden lg:flex gap-4 bg-[var(--color-bg-page)] -mt-4 pt-4 pb-2 shadow-[0_6px_0_6px_var(--color-bg-page)]">
              {DAYS.map((day) => (
                <DayHeaderCell
                  ...
                  copyPopoverDay={copyPopoverDay}
                  setCopyPopoverDay={setCopyPopoverDay}
                  holidayPopoverDay={holidayPopoverDay}
                  setHolidayPopoverDay={setHolidayPopoverDay}
                  requestCopyDay={requestCopyDay}
